...
const SpockWeapon = () => {
    return (
        <div className='bg-SpockA flex rounded-full absolute lg:h-[145px] h-[96px] lg:w-[145px] w-[96px] justify-center items-center lg:left-[0px] -left-[55px] lg:top-[362px] top-[180px] hover:cursor-pointer '>
            <div className='bg-SpockB flex rounded-full absolute lg:h-[145px] h-[96px] lg:w-[145px] w-[96px] justify-center items-center -left-0 lg:-top-[6px] top-[-4px]'>
                <div className='bg-grayShadow lg:h-[72px] h-[72px] lg:w-[110px] w-[72px] rounded-full'>
