...
const LizardWeapon = () => {
    return (
        <div className='bg-LizardA flex rounded-full absolute lg:h-[145px] h-[96px] lg:w-[145px] w-[96px] justify-center items-center lg:left-[0px] -left-[10px] lg:top-[362px] top-[301px] hover:cursor-pointer '>
